...
namespace UAAASDATA
{
    ...
    public partial class jntuh_appeal_college_laboratories
    {
        ...
        public string DelivaryChalanaImage { get; set; }
        public string BankStatementImage { get; set; }
        public string StockRegisterEntryImage { get; set; }
        public string ReVerificationScreenShot { get; set; }
